@extends('layouts.app')
@section('title','Manage Salinity Forcast Data')

@section('content')
<div class="container-fluid">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Manage Salinity Forcast Data</h6>
    </div>
    <div class="card-body">
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            "url": "{{ route('get:manage_salinity_forcast_data')}}",
              "type": 'GET',
              data: function (d) {
              }
        },
