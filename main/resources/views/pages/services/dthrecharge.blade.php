...
<div class="container-fluid">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">DTH Recharge</h6>
    </div>
    <div class="card-body">
        ...
        <div class="col-md-4 offset-md-3">
            <form action="{{ route('post:recharge') }}" method="post" enctype="multipart/form-data">
              @csrf
                ...
                <input type="hidden" value="DTH" name="rtype">
              ...
              <div class="form-group">
                <label for="phone">Customer No.:</label>
                <input type="text" class="form-control" id="mobile" placeholder="Enter Customer No." 
