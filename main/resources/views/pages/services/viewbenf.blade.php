...
<div class="container-fluid">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">View beneficiaries</h6> 
    </div>
    <div class="card-body">
        <div class="table-responsive">
<a href="{{url('add-beneficiaries')}}"  class="btn btn-primary btn-sm" tooltip="ADD BENF" title="ADD BENF" style="    float: right;">ADD BENF</a>
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            "url": "{{ route('get:view_beneficiaries_data_ajax')}}",
              "type": 'GET',
              data: function (d) {
        ...
        "columns": [
            ...
            { "data": 'benCode', "name": 'id', "sClass": "salaryright" , "render": function (data, type, full, meta) {

                var action = "";
                action += '<a href={{url("moneytransfer")}}/' + data + '  class="btn btn-success btn-sm" tooltip="Transfer" title="Transfer">Transfer</a>&nbsp;';
...
function DataDelete(id) {
  ...
  $.ajax({
    url: "{{ route('post:delete_beneficiaries') }}",
    type: "post",
