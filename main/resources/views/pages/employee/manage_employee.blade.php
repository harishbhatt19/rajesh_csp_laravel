...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "dom": 'lfrtip',
        "ajax": {
            "url": "{{ route('get:manage_employee_data')}}",
              "type": 'GET',
              data: function (d) {
              }
        },
        "columns": [
            ...
            { "data": 'id', "name": 'id', "sClass": "salaryright" , "render": function (data, type, full, meta) {
                ...
                var action = "";
                action += '<a href={{url("edit-employee")}}/' + data + '  class="btn btn-success btn-sm" tooltip="Edit" title="Edit"><i class="fas fa-edit"></i></a>&nbsp;';
...
function DataDelete(id) {
  ...
  var confirmD = confirm("Are you sure,you want to delete this employee?");
  if (!confirmD) {
    return false;
  }
  $.ajax({
    url: "{{ route('post:delete_employee') }}",
    type: "post",
