@extends('layouts.app')
@section('title')
    @if(isset($pondsdata)) Edit User Data @else Add User Data @endif
@endsection
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">@if(isset($pondsdata)) Edit User Data @else Add User Data @endif</h6>
    </div>
    <div class="card-body">
